...
l <- get_links("astro/bbcloc.html",heading="acceleration")
l
```
...
# Fix to continue
page_details$url[which(page_details$url == unvisited_urls[1])] <- "particles/hadron.html"
unvisited_urls[1] <- "particles/hadron.html"
