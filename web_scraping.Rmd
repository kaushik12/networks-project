...
l <- get_links("thermo/temper.html",heading="acceleration")
l
```
...
counter <- 0
st <- proc.time()
while(length(unvisited_urls) > 0 | counter < 500){
...
# Fix to continue
page_details$url[which(page_details$url == unvisited_urls[1])] <- "thermo/entropcon.html"
unvisited_urls[1] <- "thermo/entropcon.html"
